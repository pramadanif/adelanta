...
export const translations = {
  es: {
    ...
    "stellar.anchorDesc": "Solo en Stellar: una red de Anchors regulados (MoneyGram, Bitso, Anclap) que aceptan fiat local (CLP, MXN, COP, BRL) e emiten USDC. El cliente corporativo paga a una cuenta bancaria normal (CuentaRUT, CLABE, CBU, PIX)—nunca toca crypto. Nosotros manejamos la conversión y settlement on-chain. Otras cadenas no pueden hacer esto.",
    ...
    "impact.modelDesc": "Escalable a cualquier país con un Stellar Anchor: Chile, México, Brasil, Argentina, Colombia, Perú.",
    ...
    "impact.countries": "6 Países",
    "impact.countriesNote": "Chile, MX, CO, BR, AR, PE",
    "impact.smes": "1M+",
  ...
  en: {
    ...
    "stellar.anchorDesc": "Only on Stellar: a live network of regulated Anchors (MoneyGram, Bitso, Anclap) accepts local fiat (CLP, MXN, COP, BRL) and issues USDC. Corporate clients pay to a normal bank account (CuentaRUT, CLABE, CBU, PIX)—they never touch crypto. We handle the conversion and settlement on-chain. Other chains cannot do this.",
    ...
    "impact.modelDesc": "Scales to any country with a Stellar Anchor: Chile, Mexico, Brazil, Argentina, Colombia, Peru.",
    ...
    "impact.countries": "6 Countries",
    "impact.countriesNote": "CL, MX, CO, BR, AR, PE",
    "impact.smes": "1M+",
